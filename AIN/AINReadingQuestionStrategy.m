...
@interface AINReadingQuestionStrategy ()
...
@implementation AINReadingQuestionStrategy
...
- (void)initialData{
    ...
    dispatch_async(dispatch_get_global_queue(DISPATCH_QUEUE_PRIORITY_DEFAULT, 0), ^{
        ...
        [self.articleFetcher fetchQuestionIndexWithCompletion:^(ArticleArray * _Nullable articleArray, NSError * _Nullable error) {
...
- (void)monthPickerController:(AINMonthPickerController *)monthPicker didSelectedDate:(NSString *)selectedDate{
    ...
    readingController.articleType = Question;
    [self.hosterController.navigationController pushViewController:readingController animated:YES];
}
